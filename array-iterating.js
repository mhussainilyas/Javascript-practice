...
// let newArray = [1, 2, 3, 4, 5, 6, 4];
// let lastElem = newArray.findLast((currentEle, index, arr) => {
//     return currentEle;
// });
...
// Find the index of last element of an array
// let newArray = [1, 2, 3, 4, 5, 6, 4];
// let lastElem = newArray.findLastIndex((currentEle, index, arr) => {
//     return currentEle;
// });
// console.log(lastElem);
